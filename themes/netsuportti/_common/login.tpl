...
<div class="login-container">
	...
	<div class="login-header login-caret">
		...
		<div class="login-content">
			...
			<img src="{$WEBPATH}themes/{$THEMENAME}/images/netsuportti-login.png" width="250" height="94" alt="Netsuportti" />
	...
	<div class="login-form">
		...
		<div class="login-content">
			...
			<div class="login-bottom-links">
				...
				<a href="http://www.netsuportti.com.br" style="text-decoration: none;" target='_blank'>Netsuportti</a> - PBX IP</a> {$currentyear}.</div>
